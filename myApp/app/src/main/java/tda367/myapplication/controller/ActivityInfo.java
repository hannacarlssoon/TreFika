...
Uses LearnJava, ActivityInfo.xml, toolbar_layout, AccountManager, User, Statistics
...
public class ActivityInfo extends AppCompatActivity {
    ...
    private String getLevelTitle(){
        ...
        return query[learnJava.getCurrentLevel()].getHeading();
    }

    //sets the info text
    public void setInfoText() {
        Query[] query = learnJava.getLevelMap().get("category" + learnJava.getCurrentCategory());
        textView.setText(query[learnJava.getCurrentLevel()].getInfo());
    }
